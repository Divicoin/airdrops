...
const airDropCall = () => {
    ...
    console.log('This shows the randomly generated time, when it matches targetTime it will stop and run the airdrop call: ' )
...
const getEtherPrice = function (airDropTotal) {
  ...
  .then( res => {
      ...
      let txArr = _.map(inTransactions, function(inTransaction) {
        ...
        console.log('This is the bonus multiplier, it changes based on blocktime: ' + bonusMultiplier);
      ...
      console.log('This is a display of a parsed address with the amount purchased, based on blocktime: ')
      console.log(_.head(txArr));
      ...
      console.log('This is a display of all qualified transactions (over 1000 DIVX), with the amount purchased: ')
      console.log(_.first(totalQualified));
      // add together total supply of qualified transactions
      const sumQualified = _.sumBy(totalQualified, 'purchased');
      console.log('This is the sum of all qualified transactions: ' + sumQualified)
      ...
      console.log('This shows how much each address would receive: ')
